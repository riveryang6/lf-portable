...
git commit -m "Release LF Portable 1.4.24.10"
git tag -a v1.4.24.10 -m "LF Portable 1.4.24.10"
git push origin HEAD:main refs/tags/v1.4.24.10:refs/tags/v1.4.24.10
src/release-update/publish-release.sh \
  --release-root /path/to/release-parent/release \
  --version 1.4.24.10
gh release view v1.4.24.10 --json tagName,name,assets
```
